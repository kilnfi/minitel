...
import { INJ, PROTOCOLS, type Protocol } from '@protocols/shared';
import { Background, cn, Header, ProtocolTransactionDecoder } from '@protocols/ui';

const currentProtocol = INJ;
      ...
      <div className="flex">
        <div className={cn('relative w-full transition-all duration-300 ease-in-out')}>
          ...
          <ProtocolTransactionDecoder
            adapter={createCosmosAdapter({ protocol: INJ, name: 'injective', displayName: 'Injective' })}
          />
        </div>
      </div>
    </div>

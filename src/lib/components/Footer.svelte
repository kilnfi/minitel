...
>
  ...
  by <a href="https://www.nakamotards.com/" class="underline" target="_blank">nakamotards</a> and
  powered by

  <a href="https://kiln.fi/" class="underline flex items-center gap-1" target="_blank">
    Kiln
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38 38" fill="none" class="w-5 h-5">
      ...
      />
      <path
        d="M36.0476 16.0084L34.1999 14.1426C33.7866 13.7253 33.1151 13.7253 32.7019 14.1426L19.7999 27.171C19.5933 27.3797 19.3032 27.5121 18.9853 27.5121C18.6674 27.5121 18.3813 27.3837 18.1707 27.175L5.27273 14.1426C4.85948 13.7253 4.18796 13.7253 3.77472 14.1426L1.92703 16.0084C0.289947 17.6615 0.289947 20.3458 1.92703 21.999L16.0211 36.2312C17.6582 37.8844 20.3164 37.8844 21.9535 36.2312L36.0476 21.999C37.6847 20.3458 37.6847 17.6615 36.0476 16.0084Z"
        fill="#202020"
      />
    </svg>
  </a>
...
<svg
  ...
  class="absolute left-1/2 bottom-[-32rem] -z-10 h-[64rem] w-[64rem] -translate-x-1/2"
  aria-hidden="true"
>
  <circle
    cx="512"
